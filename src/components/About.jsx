        ...
        <>
            <div name="about" className="w-full h-auto md:h-screen flex flex-col justify-center items-center space-y-1 py-5 font-Poppins bg-gray-50">
                <div className="flex flex-col md:flex-row items-center  space-x-2 relative w-full h-auto md:h-[50vh] justify-center ">
                    <div className="h-full w-full  md:w-[50%] px-10 md:flex justify-center items-center">
                        {/* 3 box differnt size overlatping each other */}
                        <img src={Images[1]} className="bg-primary object-cover  rounded-sm  z-40 h-[300px] w-[280px]" />
                        <img src={Images[3]} className="bg-red-500 object-cover  rounded-sm absolute left-20 top-0 h-[200px] w-[180px]" />
                        <img src={Images[2]} className=" object-cover rounded-sm z-40 absolute left-32 bottom-0 h-[100px] w-[200px]" />
                    ...
                    <div className="h-full  w-full md:w-[50%] flex flex-col space-y-1 justify-center md:items-start">
                        <p className=' font-regular text-[14px] uppercase text-primary text-start'>
                            Our Introduction
                        </p>
                        <p className=' font-semibold text-xl md:text-4xl text-black text-start'>
                            Welcome to <br /> At Ease Pest Control
                        </p>
                        <p className='font-regular text-[12px]  self-start w-[68%] text-black text-justify'>
                            At Ease Pest Control, we are your trusted partner in providing effective, eco-friendly pest management solutions. We specialize in eliminating pests safely and efficiently, ensuring your home or business remains pest-free. Our team of qualified experts is dedicated to delivering fast, reliable, and affordable services tailored to meet your unique needs. Whether it's preventative treatments or immediate pest control solutions, we're here to help you maintain a comfortable and safe environment. Trust At Ease Pest Control—where peace of mind comes naturally.
                        </p>
                        <button
                ...
                <div className="flex flex-col items-center  space-x-2 relative w-full md:h-[50vh] justify-center ">
                    ...
                    <div className="w-full flex md:flex-row flex-wrap justify-center md:space-x-4 pt-8">
                        {/* Qualified Experts */}
                        <div className="md:w-[170px] w-[150px] h-[200px] space-y-3 bg-white flex flex-col justify-center items-center rounded-md shadow-xl hover:bg-primary text-black duration-300 transition-all hover:text-white group">
                        ...
                        <div className="md:w-[170px] w-[150px] h-[200px] space-y-3 bg-white flex flex-col justify-center items-center rounded-md shadow-xl hover:bg-primary text-black duration-300 transition-all hover:text-white group">
                            ...
                            <p className="font-regular text-base text-center group-hover:text-white transition-all duration-300">
                                Service On <br /> Schedule
                            </p>
                        </div>

                        {/* Affordable Prices */}
                        <div className="w-[170px] h-[200px] space-y-3 bg-white flex flex-col justify-center items-center rounded-md shadow-xl hover:bg-primary text-black duration-300 transition-all hover:text-white group">
                            <div className="bg-primary h-[55px] w-[55px] rounded-full flex items-center justify-center group-hover:bg-white transition-all duration-300">
